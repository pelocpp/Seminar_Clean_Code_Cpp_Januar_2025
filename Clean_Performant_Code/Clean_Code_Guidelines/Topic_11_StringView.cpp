...
namespace StringViewDemonstration {
    ...
    static void test_01() 
    {
        const char* x = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";  // Globalen Datensegment // Code Segment
       // x[0] = '?';
        // NICHT AM HEAP
        auto len = std::strlen(x);

        // Für Adresse + Len gibt es eine Helper-Klasse: std::string_view
    ...
    static void test_02()
    {
        ...
        std::string_view sv{ s };   // Neeeeeeeeeeeee
