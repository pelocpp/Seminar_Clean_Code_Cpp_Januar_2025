...
namespace Auto_Examples {
    ...
    static void test_01() {
        ...
        auto k = 123.345;   // Type Deduction // Typableitung 
    ...
    static void test_03_Lambda() {
        ...
        private:
            ...
            {
                return __lambda_5_21{}.operator()(n);
            }


        };

        auto lambda = [](int n) { return 2 * n; };

        // Vorsicht: std::function ist eine HÜLLENKLASSE
